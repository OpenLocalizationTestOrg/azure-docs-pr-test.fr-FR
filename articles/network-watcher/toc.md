...
## Vérifiez tooand de flux IP à partir d’une machine virtuelle
...
## [Analyser les anomalies de toofind de capture de paquet](network-watcher-deep-packet-inspection.md)
## [Utiliser l’analyse du réseau proactive toodo paquet capture avec les fonctions de Azure](network-watcher-alert-triggered-packet-capture.md)
