...
> [!IMPORTANT]
> Avant la suppression et le remplacement d’un module de batterie de secours, passez en revue les informations de sécurité hello Bonjour [remplacement de composant matériel Introduction tooStorSimple](storsimple-8000-hardware-component-replacement.md).
...
1. Bonjour portail Azure, accédez à panneau de service de gestionnaire de périphériques StorSimple tooyour. Accédez trop**périphériques** , puis sélectionnez votre appareil dans la liste des appareils hello. Accédez trop**moniteur** > **l’intégrité du matériel**. Sous **composants partagés**, regardez statut hello de batterie de hello.
...
4. Une fois terminée, remplacement de hello tooyour appareil et puis trop**moniteur** > **l’intégrité du matériel** Bonjour portail Azure. Vérifiez l’état hello de hello toomake de batterie que que hello installation a réussi. Un état vert indique que la batterie de hello est sain.
...
Bonjour portail Azure, hello **l’intégrité du matériel** sous hello **moniteur** panneau indique si la batterie de hello est défectueux ou hello en fin de vie est proche. état de la batterie Hello est indiqué par **batterie dans PCM 0** ou **batterie dans PCM 1** sous **composants partagés**. Ce panneau indiquera l’état **DÉTÉRIORÉ** si la fin de durée de vie approche et l’état **ÉCHEC** si elle est atteinte.
...
* S’il n’a pas été une entraîne une perte d’alimentation secteur et hello PCM est allumée et connecté tooAC power, batterie de hello doit toobe remplacé. [Contactez le Support Microsoft](storsimple-8000-contact-microsoft-support.md) tooorder un module de batterie de secours.
