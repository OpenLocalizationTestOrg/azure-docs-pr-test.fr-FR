...
## Vue d'ensemble
### [Quelle est la solution de hello ?](storsimple-ova-overview.md)
...
### Déployer
#### [Préparer toodeploy](storsimple-virtual-array-deploy1-portal-prep.md)
...
## Vue d'ensemble
### [Quelle est la solution de hello ?](storsimple-overview.md)
...
##### [Se connecter à distance des périphériques de tooyour](storsimple-8000-remote-connect.md)
...
###### [Basculer toophysical périphérique](storsimple-8000-device-failover-physical-device.md)
###### [Basculer toocloud appliance](storsimple-8000-device-failover-cloud-appliance.md)
###### [Basculer toosame périphérique](storsimple-8000-device-failover-same-device.md)
...
#### [Automatiser le serveur de fichiers tooAzure de récupération d’urgence](storsimple-disaster-recovery-using-azure-site-recovery.md)
...
#### [À partir d’autres appareils de stockage](http://download.microsoft.com/download/9/4/A/94AB8165-CCC4-430B-801B-9FD40C8DA340/Migrating Data tooStorSimple Volumes_09-02-15.pdf)
...
##### [Se connecter à distance des périphériques de tooyour](storsimple-remote-connect.md)
...
## Vue d'ensemble
### [Quelle est la solution de hello ?](storsimple-data-manager-overview.md)

## Prise en main
### [Utilisation de StorSimple Data Manager](storsimple-data-manager-ui.md)

## Procédures
### [Utilisez des tâches de toostart .NET](storsimple-data-manager-dotnet-jobs.md)
### [Utilisez les tâches d’automatisation toostart](storsimple-data-manager-job-using-automation.md)
...
## Vue d'ensemble
### [Quelle est la solution de hello ?](storsimple-partner-csp-overview.md)
