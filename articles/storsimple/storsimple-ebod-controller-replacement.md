...
1. Ouvrez hello portail Azure classic.
2. Accédez trop**périphériques** > **Maintenance** > **état du matériel**et vérifiez que les DEL d’état de hello Hello pour hello EBOD active module de contrôleur est vert, hello DEL de module de contrôleur EBOD hello a échoué est rouge.
