...
---
# <a name="use-hello-storsimple-manager-service-toomonitor-hardware-components-and-status"></a>Utiliser des composants matériels de hello StorSimple Manager service toomonitor et l’état
## <a name="overview"></a>Vue d'ensemble
Cet article décrit hello divers composants physiques et logiques de l’appareil StorSimple local. Elle explique également comment toomonitor hello état du périphérique à l’aide de hello **Maintenance** page Bonjour service StorSimple Manager. 

Hello **Maintenance** page affiche l’état du matériel de tous les composants de périphérique StorSimple hello hello. 
...
> [!NOTE]
> **section de statut matériel Hello n’est pas présente dans la page Maintenance de hello pour un appareil virtuel de StorSimple (1100).**
> 
> 
...
1. Accédez trop**périphériques**, sélectionnez un périphérique StorSimple spécifique. Dans le menu de niveau de l’appareil hello toogo, puis cliquez sur **Maintenance**. 
2. Recherchez hello **état du matériel** section et choisir parmi les composants disponibles hello (comme décrit ci-dessus). Cliquez simplement sur une flèche qui précède hello étiquette tooexpand hello liste et vue hello état du composant de hello différents composants de l’appareil. Consultez hello [liste de composant détaillé pour le boîtier principal de hello](#component-list-for-primary-enclosure-of-storsimple-device) et hello [liste de composant détaillé pour hello boîtiers](#component-list-for-ebod-enclosure-of-storsimple-device).
...
Hello tableau suivant indique hello composants physiques et logiques contenus dans le boîtier principal de hello d’appareil StorSimple local.
...
Hello tableau suivant indique hello composants physiques et logiques contenus dans hello boîtier EBOD d’appareil StorSimple local.
...
* toouse hello, tooadminister du service StorSimple Manager votre appareil, accédez trop[utilisez hello tooadminister du service StorSimple Manager de votre appareil StorSimple](storsimple-manager-service-administration.md).
...
* Si vous continuez de problèmes de l’appareil tooexperience, [contactez le Support Microsoft](storsimple-contact-microsoft-support.md).
