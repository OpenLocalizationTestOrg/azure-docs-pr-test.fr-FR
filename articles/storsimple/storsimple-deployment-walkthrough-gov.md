...
---
# <a name="deploy-your-on-premises-storsimple-device-in-hello-government-portal"></a>Déployer l’appareil StorSimple local Bonjour portail d’administration
[!INCLUDE [storsimple-version-selector-deploy-gov](../../includes/storsimple-version-selector-deploy-gov.md)]

## <a name="overview"></a>Vue d'ensemble
Bienvenue dans le déploiement d’appareil Azure StorSimple tooMicrosoft. Ces didacticiels de déploiement appliquent toohello StorSimple 8000 Series en cours d’exécution 1 de mise à jour de logiciel Bonjour Azure Government Portal. Cette série de didacticiels décrit comment tooconfigure votre appareil StorSimple et inclut une liste de vérification de configuration, configuration requise et la configuration détaillée comme suit.
...
| &nbsp; |Clé d'inscription du service |Cette clé est générée à partir de hello portail Azure. | |
