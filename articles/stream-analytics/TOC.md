...
### [Fonctions de sortie tooAzure](stream-analytics-functions-redis.md)
### [Sortie tooData Lake Store](stream-analytics-data-lake-output.md)
### [Sortie tooDocumentDB](stream-analytics-documentdb-output.md)
...
### [Débit de tooincrease de mise à l’échelle](stream-analytics-scale-jobs.md)
...
### [Utilisez hello Management .NET SDK](stream-analytics-dotnet-management-sdk.md)
