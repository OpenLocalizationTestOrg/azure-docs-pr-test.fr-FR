...
Dans ce didacticiel, vous apprendrez comment toointegrate Envoy avec Azure Active Directory (Azure AD).

Intégration Envoy à Azure AD offre hello avantages suivants :

- Vous pouvez contrôler dans Azure AD qui a accès tooEnvoy.
- Vous pouvez activer vos utilisateurs tooautomatically get connecté tooEnvoy (Single Sign-On) avec leurs comptes Azure AD.
...
tooconfigure intégration d’Azure AD à Envoy, vous devez hello éléments suivants :
...
1. Ajout d’envoi à partir de la galerie de hello
2. Configuration et test de l’authentification unique Azure AD

## <a name="adding-envoy-from-hello-gallery"></a>Ajout d’envoi à partir de la galerie de hello
tooconfigure hello intégration de Envoy dans Azure AD, vous devez tooadd Envoy à partir de la liste de tooyour hello Galerie d’applications SaaS gérées.

**tooadd Envoy à partir de la galerie hello, procédez hello comme suit :**
...
4. Dans la zone de recherche de hello, tapez **Envoy**, sélectionnez **Envoy** à partir du volet de résultats, puis sur **ajouter** bouton application hello de tooadd.
...
Pour toowork de l’authentification unique, Azure AD doit tooknow quel utilisateur équivalent hello Envoy est tooa utilisateur dans Azure AD. En d’autres termes, une relation de lien entre un utilisateur Azure AD et un utilisateur hello dans Envoy doit toobe établie.

Dans Envoy, affecter la valeur hello hello **nom d’utilisateur** dans Azure AD en tant que valeur hello Hello **nom d’utilisateur** relation de lien tooestablish hello.

tooconfigure et test Azure AD l’authentification unique à Envoy, vous devez hello toocomplete suivant des blocs de construction :
...
3. **[Créer un utilisateur de test Envoy](#create-an-envoy-test-user)**  -toohave un équivalent de Britta Simon dans Envoy est la représentation sous forme de toohello lié Azure AD de l’utilisateur.
...
Dans cette section, vous activez Azure AD l’authentification unique sur Bonjour portail Azure et configurez l’authentification unique dans votre application d’envoi.

**tooconfigure Azure AD single sign-on avec Envoy, procédez hello comme suit :**

1. Bonjour portail Azure, sur hello **Envoy** page d’intégration d’application, cliquez sur **l’authentification unique**.
...
3. Sur hello **Envoy domaine et les URL** section, effectuer hello comme suit :
    ...
    Bonjour **URL de connexion** zone de texte, tapez une URL à l’aide de hello modèle :`https://<tenant-name>.Envoy.com`
    
    > [!NOTE] 
    > Cette valeur n’est pas la valeur réelle. Mettre à jour de cette valeur avec hello URL de connexion réel. Contact [équipe de support Client de Envoy](https://envoy.com/contact/) tooget cette valeur.
...
6. Sur hello **Envoy Configuration** , cliquez sur **Envoy de configurer** tooopen **configurer l’authentification** fenêtre. Hello de copie **SAML Sign-On URL du Service unique** de hello **section de référence rapide.**
...
11. Bonjour **l’authentification SAML** configuration section, effectuer hello comme suit :

    ![SAML authentication](./media/active-directory-saas-envoy-tutorial/ic776785.png "SAML authentication")
    
    >[!NOTE]
    >valeur de Hello pour l’ID d’emplacement du siège hello est générée automatiquement par l’application hello.
    
    a. Dans **par empreinte digitale** zone de texte, collez hello **l’empreinte numérique** valeur de certificat, ce qui vous avez copié à partir du portail Azure.
    
    b. Coller **SAML Sign-On URL du Service unique** valeur, qui vous avez copié écran hello Azure portail dans hello **URL SAML HTTP du fournisseur d’identité** zone de texte.
...
Il n’existe aucun élément d’action pour vous tooconfigure configuration de l’utilisateur tooEnvoy. Quand un utilisateur affecté tente de toolog à Envoy à l’aide du volet d’accès hello, Envoy vérifie l’existence d’un utilisateur de hello. Si aucun compte d'utilisateur n’est disponible, Envoy le crée automatiquement.

### <a name="assign-hello-azure-ad-test-user"></a>Affecter l’utilisateur de test hello Azure AD

Dans cette section, vous activez toouse Britta Simon Azure l’authentification unique en accordant l’accès tooEnvoy.

![Attribuer le rôle d’utilisateur hello][200] 

**tooassign Britta Simon tooEnvoy, effectuez hello comme suit :**

1. Bonjour portail Azure, ouvrez la vue des applications hello, puis naviguez toohello vue d’annuaire et accédez trop**des applications d’entreprise** puis cliquez sur **toutes les applications**.

    ![Affecter des utilisateurs][201] 

2. Dans la liste des applications hello, sélectionnez **Envoy**.
...
Lorsque vous cliquez sur mosaïque Envoy hello hello volet d’accès, vous devez obtenir l’application d’Envoy automatiquement signé sur tooyour.
