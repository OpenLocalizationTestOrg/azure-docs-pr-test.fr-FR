...
Dans ce didacticiel, vous apprendrez comment toointegrate Mimecast Personal Portal avec Azure Active Directory (Azure AD).

Intégration de Mimecast Personal Portal à Azure AD offre hello avantages suivants :

- Vous pouvez contrôler dans Azure AD qui a accès tooMimecast Personal Portal
- Vous pouvez activer vos utilisateurs tooautomatically get connecté tooMimecast Personal Portal (Single Sign-On) avec leurs comptes Azure AD
...
tooconfigure intégration d’Azure AD avec Mimecast Personal Portal, vous devez hello éléments suivants :
...
1. Ajout de Mimecast Personal Portal à partir de la galerie de hello
2. Configuration et test de l’authentification unique Azure AD

## <a name="adding-mimecast-personal-portal-from-hello-gallery"></a>Ajout de Mimecast Personal Portal à partir de la galerie de hello
intégration de hello tooconfigure de Mimecast Personal Portal dans Azure AD, vous devez tooadd Mimecast Personal Portal à partir de la liste de tooyour hello Galerie d’applications SaaS gérées.

**tooadd Mimecast Personal Portal à partir de la galerie hello, procédez hello comme suit :**
...
4. Dans la zone de recherche de hello, tapez **Mimecast Personal Portal**.
...
5. Dans le volet de résultats hello, sélectionnez **Mimecast Personal Portal**, puis cliquez sur **ajouter** bouton application hello de tooadd.
...
Pour toowork de l’authentification unique, Azure AD doit tooknow quel utilisateur d’équivalent hello dans Mimecast Personal Portal est tooa utilisateur dans Azure AD. En d’autres termes, une relation de lien entre un utilisateur Azure AD et un utilisateur hello dans Mimecast Personal Portal doit toobe établie.

Dans Mimecast Personal Portal, affecter la valeur hello hello **nom d’utilisateur** dans Azure AD en tant que valeur hello Hello **nom d’utilisateur** relation de lien tooestablish hello.

tooconfigure et test Azure AD l’authentification unique avec Mimecast Personal Portal, vous devez hello toocomplete suivant des blocs de construction :

1. **[Configuration d’Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  -tooenable toouse de vos utilisateurs cette fonctionnalité.
2. **[Création d’un utilisateur de test Azure AD](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign-on avec Britta Simon.
3. **[Création d’un utilisateur de test de Mimecast Personal Portal](#creating-a-mimecast-personal-portal-test-user)**  -toohave un équivalent de Britta Simon dans Mimecast Personal Portal est la représentation sous forme de toohello lié Azure AD de l’utilisateur.
4. **[Utilisateur de test affectation hello Azure AD](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD de l’authentification unique.
5. **[Test de l’authentification unique sur](#testing-single-sign-on)**  -tooverify hello indique si les tâches de configuration.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuration de l’authentification unique Azure AD

Dans cette section, vous activez Azure AD l’authentification unique sur Bonjour portail Azure et configurez l’authentification unique dans votre application Mimecast Personal Portal.

**tooconfigure Azure AD l’authentification unique avec Mimecast Personal Portal, procédez hello comme suit :**

1. Bonjour portail Azure, sur hello **Mimecast Personal Portal** page d’intégration d’application, cliquez sur **l’authentification unique**.
...
3. Sur hello **Mimecast Personal Portal domaine et les URL** section, effectuer hello comme suit :
    ...
    > [!NOTE] 
    > Il ne s’agit pas de valeurs réelles. Mettre à jour les valeurs de hello réel Sign-On URL et l’identificateur. Contact [équipe de support technique de Mimecast Personal Portal Client](https://www.mimecast.com/customer-success/technical-support/) tooget ces valeurs. 
...
6. Sur hello **Mimecast Personal Portal Configuration** , cliquez sur **configurer Mimecast Personal Portal** tooopen **configurer l’authentification** fenêtre. Hello de copie **URL de déconnexion, ID d’entité SAML et SAML Sign-On URL du Service unique** de hello **section de référence rapide.**
...
8. Accédez trop**Services \> Applications**.
...
11. Bonjour **profil d’authentification** section, effectuer hello comme suit :
    ...
    d. Dans **URL de l’émetteur** zone de texte, valeur hello coller **ID d’entité SAML** dont vous avez copié à partir du portail Azure.
   
    e. Dans **URL de connexion** zone de texte, valeur hello coller **SAML Sign-On URL du Service unique** dont vous avez copié à partir du portail Azure.
    ...
    g. Ouvrez votre **base-64** certificat dans le bloc-notes téléchargé à partir du portail Azure, hello copie contenu de celui-ci dans le Presse-papiers et le coller ensuite toohello **certificat de fournisseur d’identité (métadonnées)** zone de texte.
...
Dans l’ordre tooenable Azure AD les utilisateurs toolog à Mimecast Personal Portal, vous devez les configurer dans Mimecast Personal Portal. Dans les cas de hello de Mimecast Personal Portal, cette configuration est une tâche manuelle.
...
1. Ouverture de session tooyour **Mimecast Personal Portal** en tant qu’administrateur.
...
5. Dans hello adresse boîte de dialogue Nouveau, effectuez hello suivant les étapes d’un Azure valide compte AD tooprovision :
   
    ![Enregistrer](./media/active-directory-saas-mimecast-personal-portal-tutorial/ic795006.png "enregistrer")
   
    a. Bonjour **adresse de messagerie** zone de texte, type **adresse de messagerie** d’utilisateur hello en tant que  **BrittaSimon@contoso.com** .
    
    b. Bonjour **nom Global** hello de type zone de texte **nom d’utilisateur** en tant que **BrittaSimon**.

    c. Bonjour **mot de passe**, et **confirmer le mot de passe** zones de texte, hello de type **mot de passe** d’utilisateur de hello.
   
    b. Cliquez sur **Enregistrer**.

>[!NOTE]
>Vous pouvez utiliser tout autre outil de création de compte utilisateur Mimecast Personal Portal ou API fournie par les comptes d’utilisateur Mimecast Personal Portal tooprovision Azure AD. 

### <a name="assigning-hello-azure-ad-test-user"></a>Affectation d’utilisateur de test hello Azure AD

Dans cette section, vous activez toouse Britta Simon Azure l’authentification unique en accordant l’accès tooMimecast Personal Portal.

![Affecter des utilisateurs][200] 

**tooassign Britta Simon tooMimecast Personal Portal, procédez hello comme suit :**

1. Bonjour portail Azure, ouvrez la vue des applications hello, puis naviguez toohello vue d’annuaire et accédez trop**des applications d’entreprise** puis cliquez sur **toutes les applications**.

    ![Affecter des utilisateurs][201] 

2. Dans la liste des applications hello, sélectionnez **Mimecast Personal Portal**.
...
Lorsque vous cliquez sur mosaïque de Mimecast Personal Portal hello Bonjour volet d’accès, vous devez obtenir l’application de Mimecast Personal Portal tooyour automatiquement signé sur. Pour plus d’informations sur hello volet d’accès, consultez [Introduction toohello volet d’accès](active-directory-saas-access-panel-introduction.md).
