...
Dans ce didacticiel, vous apprendrez comment toointegrate Nomadic avec Azure Active Directory (Azure AD).

Intégration Nomadic à Azure AD offre hello avantages suivants :

- Vous pouvez contrôler dans Azure AD qui a accès tooNomadic.
- Vous pouvez activer vos utilisateurs tooautomatically get connecté tooNomadic (Single Sign-On) avec leurs comptes Azure AD.
...
tooconfigure intégration d’Azure AD avec Nomadic, vous devez hello éléments suivants :
...
1. Ajouter des Nomadic à partir de la galerie de hello
2. Configurer et tester l’authentification unique Azure AD

## <a name="add-nomadic-from-hello-gallery"></a>Ajouter des Nomadic à partir de la galerie de hello
intégration de hello tooconfigure de Nomadic dans Azure AD, vous devez tooadd Nomadic à partir de la liste de tooyour hello Galerie d’applications SaaS gérées.

**tooadd Nomadic à partir de la galerie hello, procédez hello comme suit :**
...
4. Dans la zone de recherche de hello, tapez **Nomadic**, sélectionnez **Nomadic** à partir du volet de résultats, puis sur **ajouter** bouton application hello de tooadd.
...
Pour toowork de l’authentification unique, Azure AD doit tooknow quel utilisateur d’équivalent hello dans Nomadic est tooa utilisateur dans Azure AD. En d’autres termes, une relation de lien entre un utilisateur Azure AD et un utilisateur hello dans Nomadic doit toobe établie.

Dans Nomadic, affecter la valeur hello hello **nom d’utilisateur** dans Azure AD en tant que valeur hello Hello **nom d’utilisateur** relation de lien tooestablish hello.

tooconfigure et test Azure AD l’authentification unique avec Nomadic, vous devez hello toocomplete suivant des blocs de construction :
...
3. **[Créer un utilisateur test nomades](#create-a-nomadic-test-user)**  -toohave un équivalent de Britta Simon dans Nomadic est la représentation sous forme de toohello lié Azure AD de l’utilisateur.
...
Dans cette section, vous activez Azure AD l’authentification unique sur Bonjour portail Azure et configurez l’authentification unique dans votre application nomades.

**tooconfigure Azure AD single sign-on avec Nomadic, effectuez hello comme suit :**

1. Bonjour portail Azure, sur hello **Nomadic** page d’intégration d’application, cliquez sur **l’authentification unique**.
...
3. Sur hello **domaine nomades et URL** section, effectuer hello comme suit :
    ...
    a. Bonjour **URL de connexion** zone de texte, tapez une URL à l’aide de hello modèle :`https://<company name>.nomadic.fm/signin`

    b. Bonjour **identificateur** zone de texte, tapez une URL à l’aide de hello modèle : `https://<company name>.nomadic.fm/auth/saml2/sp`,`https://<company name>.staging.nomadic.fm/auth/saml2/sp`

    > [!NOTE] 
    > Il ne s’agit pas de valeurs réelles. Mettre à jour les valeurs de hello réel Sign-On URL et l’identificateur. Contact [équipe de support Client nomades](mailto:help@nomadic.fm) tooget ces valeurs. 
...
6.  tooget l’authentification unique configurée pour votre application, contactez [équipe de support nomades](mailto:help@nomadic.fm) et fournissez-leur hello téléchargé **métadonnées**.
...
Dans cette section, vous créez un utilisateur nommé Britta Simon dans Nomadic. Collaborez avec [équipe de support nomades](mailto:help@nomadic.fm) utilisateurs hello tooadd plateforme nomades de hello.

### <a name="assign-hello-azure-ad-test-user"></a>Affecter l’utilisateur de test hello Azure AD

Dans cette section, vous activez toouse Britta Simon Azure l’authentification unique en accordant l’accès tooNomadic.

![Attribuer le rôle d’utilisateur hello][200] 

**tooassign Britta Simon tooNomadic, effectuez hello comme suit :**

1. Bonjour portail Azure, ouvrez la vue des applications hello, puis naviguez toohello vue d’annuaire et accédez trop**des applications d’entreprise** puis cliquez sur **toutes les applications**.

    ![Affecter des utilisateurs][201] 

2. Dans la liste des applications hello, sélectionnez **Nomadic**.
...
Lorsque vous cliquez sur la vignette de nomades hello dans hello volet d’accès, vous devez obtenir les applications nomades tooyour automatiquement signé sur.
