...
objectif de ce didacticiel Hello est tooshow vous hello étapes que vous devez tooperform dans LinkedIn Learning et Azure AD tooautomatically approvisionner et configurer des comptes d’utilisateur à partir d’Azure AD tooLinkedIn d’apprentissage. 
...
*   Un compte d’administrateur pour la formation LinkedIn avec accès toohello LinkedIn centre des comptes

> [!NOTE]
> Azure Active Directory s’intègre avec Learning LinkedIn à l’aide de hello [SCIM](http://www.simplecloud.info/) protocole.

## <a name="assigning-users-toolinkedin-learning"></a>Affectation d’utilisateurs tooLinkedIn d’apprentissage
...
### <a name="important-tips-for-assigning-users-toolinkedin-learning"></a>Conseils importants pour l’affectation d’utilisateurs tooLinkedIn d’apprentissage

*   Il est recommandé qu’un seul utilisateur Azure AD avoir hello de tootest Learning tooLinkedIn service de la configuration. Les autres utilisateurs et/ou groupes peuvent être affectés ultérieurement.

*   Lors de l’attribution d’un utilisateur tooLinkedIn d’apprentissage, vous devez sélectionner hello **utilisateur** rôle dans la boîte de dialogue attribution hello. rôle de « Accès par défaut » Hello ne fonctionne pas pour la configuration.


## <a name="configuring-user-provisioning-toolinkedin-learning"></a>Configuration utilisateur tooLinkedIn d’apprentissage

Cette section vous guide à travers de la connexion du compte d’utilisateur de votre apprentissage Azure AD tooLinkedIn SCIM API de configuration et configurez hello toocreate du service de configuration, de mettre à jour et de désactiver les comptes d’utilisateur affecté dans Learning LinkedIn en fonction de l’utilisateur et de groupe affectation dans Azure AD.

> [!TIP]
> Vous pouvez également choisir tooenabled basé sur SAML Single Sign-On pour l’apprentissage LinkedIn, suivant les instructions hello fournies dans [portail Azure](https://portal.azure.com). L’authentification unique peut être configurée indépendamment de l’approvisionnement automatique, bien que ces deux fonctionnalités se complètent.


### <a name="tooconfigure-automatic-user-account-provisioning-toolinkedin-learning-in-azure-ad"></a>compte d’utilisateur automatique de tooconfigure tooLinkedIn l’approvisionnement d’apprentissage dans Azure AD :
...
8) Si vous avez déjà configuré LinkedIn Learning pour l’authentification unique, recherchez votre instance de la formation LinkedIn à l’aide du champ de recherche hello. Sinon, sélectionnez **ajouter** et recherchez **LinkedIn Learning** dans la galerie d’applications hello. Sélectionnez LinkedIn Learning à partir des résultats de recherche hello et ajoutez-le tooyour la liste des applications.

9)  Sélectionnez votre instance de la formation de LinkedIn, puis hello **Provisioning** onglet.
