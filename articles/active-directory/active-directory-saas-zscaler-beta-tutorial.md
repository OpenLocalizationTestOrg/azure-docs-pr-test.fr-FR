...
Dans ce didacticiel, vous apprendrez comment toointegrate Zscaler Beta avec Azure Active Directory (Azure AD).

Intégration de Zscaler Beta à Azure AD offre hello avantages suivants :

- Vous pouvez contrôler dans Azure AD qui a accès tooZscaler bêta
- Vous pouvez activer vos utilisateurs tooautomatically get connecté tooZscaler bêta (Single Sign-On) avec leurs comptes Azure AD
...
tooconfigure intégration d’Azure AD à Zscaler Beta, vous devez hello éléments suivants :
...
1. Ajout de Zscaler Beta à partir de la galerie de hello
2. Configuration et test de l’authentification unique Azure AD

## <a name="adding-zscaler-beta-from-hello-gallery"></a>Ajout de Zscaler Beta à partir de la galerie de hello
intégration de hello tooconfigure de Zscaler Beta dans Azure AD, vous devez tooadd Zscaler Beta à partir de la liste de tooyour hello Galerie d’applications SaaS gérées.

**tooadd Zscaler Beta à partir de la galerie hello, procédez hello comme suit :**
...
4. Dans la zone de recherche de hello, tapez **Zscaler Beta**.
...
5. Dans le volet de résultats hello, sélectionnez **Zscaler Beta**, puis cliquez sur **ajouter** bouton application hello de tooadd.
...
Pour toowork de l’authentification unique, Azure AD doit tooknow quel utilisateur d’équivalent hello dans Zscaler Beta est tooa utilisateur dans Azure AD. En d’autres termes, une relation de lien entre un utilisateur Azure AD et un utilisateur hello dans Zscaler Beta doit toobe établie.

Dans Zscaler Beta, affecter la valeur hello hello **nom d’utilisateur** dans Azure AD en tant que valeur hello Hello **nom d’utilisateur** relation de lien tooestablish hello.

tooconfigure et test Azure AD l’authentification unique sur Zscaler Beta, vous devez hello toocomplete suivant des blocs de construction :
...
4. **[Création d’un utilisateur de test de Zscaler Beta](#creating-a-zscaler-beta-test-user)**  -toohave un équivalent de Britta Simon dans Zscaler Beta qui est la représentation sous forme de toohello lié Azure AD de l’utilisateur.
...
Dans cette section, vous activez Azure AD l’authentification unique sur Bonjour portail Azure et configurez l’authentification unique dans votre application Zscaler Beta.

**tooconfigure Azure AD l’authentification unique sur Zscaler Beta, procédez hello comme suit :**

1. Bonjour portail Azure, sur hello **Zscaler Beta** page d’intégration d’application, cliquez sur **l’authentification unique**.
...
3. Sur hello **Zscaler Beta domaine et les URL** section, effectuer hello comme suit :

    ![Configurer l’authentification unique](./media/active-directory-saas-zscaler-beta-tutorial/tutorial_zscalerbeta_url.png)

    Zone de texte URL hello Sign-on, tapez hello l’URL utilisée par vos utilisateurs sur toosign tooyour application Zscaler Beta.

    > [!NOTE] 
    > Vous avez tooupdate cette valeur avec hello URL de connexion réel. Contact [équipe de support technique Zscaler Beta Client](https://www.zscaler.com/company/contact) tooget cette valeur. 
...
6. Sur hello **Zscaler Beta Configuration** , cliquez sur **configurer Zscaler Beta** tooopen **configurer l’authentification** fenêtre. Hello de copie **SAML Sign-On URL du Service unique** de hello **section de référence rapide.**
...
7. Dans une fenêtre de navigateur web, connectez-vous tooyour site de société Zscaler Beta en tant qu’administrateur.
...
5. Dans la section serveur Proxy de hello, procédez hello comme suit :   
    ...
    b. Dans la zone de texte adresse hello, tapez **gateway.zscalerbeta.net**.
...
tooenable Azure AD les utilisateurs toolog tooZscaler bêta, elles doivent être mis en service tooZscaler bêta. Dans les cas de hello de Zscaler Beta, cette configuration est une tâche manuelle.
...
1. Connectez-vous à tooyour **Zscaler Beta** client.
...
> [!NOTE]
> Vous pouvez utiliser n’importe quel autre Zscaler Beta utilisateur compte outil de création ou API fournie par Zscaler Beta tooprovision comptes d’utilisateur Azure AD.

### <a name="assigning-hello-azure-ad-test-user"></a>Affectation d’utilisateur de test hello Azure AD

Dans cette section, vous activez toouse Britta Simon Azure l’authentification unique en accordant l’accès tooZscaler bêta.

![Affecter des utilisateurs][200] 

**tooassign Britta Simon tooZscaler bêta, effectuez hello comme suit :**

1. Bonjour portail Azure, ouvrez la vue des applications hello, puis naviguez toohello vue d’annuaire et accédez trop**des applications d’entreprise** puis cliquez sur **toutes les applications**.

    ![Affecter des utilisateurs][201] 

2. Dans la liste des applications hello, sélectionnez **Zscaler Beta**.
...
Lorsque vous cliquez sur hello Zscaler Beta vignette Bonjour volet d’accès, vous devez obtenir automatiquement signé sur tooyour application Zscaler Beta.
