...
2.  <span data-ttu-id="8f01d-126">Saisissez `dsregcmd.exe /debug /leave`</span><span class="sxs-lookup"><span data-stu-id="8f01d-126">Type `dsregcmd.exe /debug /leave`</span></span>
