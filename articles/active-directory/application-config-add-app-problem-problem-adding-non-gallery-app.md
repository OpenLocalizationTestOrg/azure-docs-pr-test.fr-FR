---
title: "aaaProblem Ajout d’une application non-galerie | Documents Microsoft"
description: "Comprendre le cadran de personnes hello courantes des problèmes lors de l’ajout d’applications galerie non personnalisées"
...
Cet article vous a-t-il face de personnes toounderstand hello courantes des problèmes lors de l’ajout **des applications non-galerie personnalisées** et vous pouvez faire tooresolve les. 
...
Dans certaines circonstances, il peut prendre 1 à 2 minutes (et parfois plus) pour un tooappear application après l’avoir ajoutée tooyour active. Bien que cela ne soit pas performances normales hello, vous pouvez voir l’ajout d’application hello est en cours d’exécution en cliquant sur hello **Notifications** icône (clochette hello) dans hello coin supérieur droit hello [Azure Portal](https://portal.azure.com/)et en recherchant un **en cours** ou **terminé** notification étiquetée **créer application**.
...
Si vous avez besoin d’aide à en savoir plus sur les applications personnalisées, hello [Azure bibliothèque de documents des Applications AD](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index) vous aider à toolearn en savoir plus sur l’authentification unique sur auprès d’Azure AD et comment il fonctionne.
...
6.  Cliquez sur hello **icône de copie** toohello à droite de hello **copiez erreur** toocopy de zone de texte tous les hello tooshare détails de notification avec un ingénieur du groupe de produit ou de la prise en charge.
