...
### [Modèles de tooother de lien](resource-group-linked-templates.md)
...
### [Utiliser des balises tooorganize ressources](resource-group-using-tags.md)
### [Déplacer le groupe de ressources de toonew ou d’un abonnement](resource-group-move-resources.md)
...
### [Abonnements tooaccess API d’authentification](resource-manager-api-authentication.md)
...
### [Utiliser la stratégie de portail tooassign](resource-manager-policy-portal.md)
### [Utiliser la stratégie de scripts tooassign](resource-manager-policy-create-assign.md)
### Exemples
