...
---
# <a name="manage-reference-data-for-an-azure-time-series-insights-environment-by-using-c"></a><span data-ttu-id="0dcb1-103">Gérer des données de référence pour un environnement Azure Time Series Insights à l’aide de C#</span><span class="sxs-lookup"><span data-stu-id="0dcb1-103">Manage reference data for an Azure Time Series Insights environment by using C#</span></span>

<span data-ttu-id="0dcb1-104">Cet exemple c# montre comment toomanage référencer des données pour un environnement Azure Insights de série de temps.</span><span class="sxs-lookup"><span data-stu-id="0dcb1-104">This C# sample demonstrates how toomanage reference data for an Azure Time Series Insights environment.</span></span>
<span data-ttu-id="0dcb1-105">Avant d’en cours d’exécution exemple hello, vérifiez hello suivant étapes est terminée.</span><span class="sxs-lookup"><span data-stu-id="0dcb1-105">Before running hello sample, ensure hello following steps are completed.</span></span>
1. <span data-ttu-id="0dcb1-106">Un jeu de données de référence a été créé à l’aide de [cet article](time-series-insights-add-reference-data-set.md).</span><span class="sxs-lookup"><span data-stu-id="0dcb1-106">A reference data set has been created using [this article](time-series-insights-add-reference-data-set.md).</span></span>
2. <span data-ttu-id="0dcb1-107">jeton d’accès Hello utilisé lors de l’application hello en cours d’exécution est obtenu via hello API Azure Active Directory.</span><span class="sxs-lookup"><span data-stu-id="0dcb1-107">hello access token used when running hello application is acquired through hello Azure Active Directory API.</span></span> <span data-ttu-id="0dcb1-108">Ce jeton doit être passé hello `Authorization` en-tête de chaque demande de requête API.</span><span class="sxs-lookup"><span data-stu-id="0dcb1-108">This token should be passed in hello `Authorization` header of every Query API request.</span></span> <span data-ttu-id="0dcb1-109">Pour configurer les applications non interactives, consultez hello [authentification et autorisation](time-series-insights-authentication-and-authorization.md) l’article.</span><span class="sxs-lookup"><span data-stu-id="0dcb1-109">For setting up non-interactive applications, see hello [Authentication and authorization](time-series-insights-authentication-and-authorization.md) article.</span></span>
3. <span data-ttu-id="0dcb1-110">Toutes les constantes hello définies au début de hello d’exemple hello sont correctement définies.</span><span class="sxs-lookup"><span data-stu-id="0dcb1-110">All hello constants defined at hello beginning of hello sample are correctly set.</span></span>

## <a name="c-sample"></a><span data-ttu-id="0dcb1-111">Exemple de code C#</span><span class="sxs-lookup"><span data-stu-id="0dcb1-111">C# sample</span></span>
...
## <a name="next-steps"></a><span data-ttu-id="0dcb1-112">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="0dcb1-112">Next steps</span></span>

<span data-ttu-id="0dcb1-113">Pour la référence d’API complète hello, consultez [API de données de référence](/rest/api/time-series-insights/time-series-insights-reference-reference-data-api) document.</span><span class="sxs-lookup"><span data-stu-id="0dcb1-113">For hello complete API reference, see [Reference Data API](/rest/api/time-series-insights/time-series-insights-reference-reference-data-api) document.</span></span>
