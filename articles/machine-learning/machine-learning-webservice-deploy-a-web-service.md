...
Pour plus d’informations sur l’utilisation de services web, voir [Utilisation d’un service web Azure Machine Learning](machine-learning-consume-web-services.md).
