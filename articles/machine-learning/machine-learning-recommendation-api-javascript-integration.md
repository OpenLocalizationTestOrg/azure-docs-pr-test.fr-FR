...
## <a name="2-prerequisites"></a>2. Prérequis
...
3. Initialisez la bibliothèque Azure ML Recommandations avec les paramètres appropriés.
     ...
     <script> AzureMLRecommendationsStart("<base64encoding of username:key>", "<ID_modèle>"); </script>
4. Envoyez l’événement approprié. Consultez la section détaillée ci-dessous sur tous les types d’événements (exemple d’événement Click) <script> if (typeof AzureMLRecommendationsEvent=="undefined") {         
