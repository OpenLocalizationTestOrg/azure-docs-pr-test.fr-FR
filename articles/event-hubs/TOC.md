...
### [Utilisez hello Azure tooenable portail capturer des concentrateurs d’événements](event-hubs-capture-enable-through-portal.md)
### [Utilisez un tooenable de modèle de gestionnaire de ressources capturer des concentrateurs d’événements](event-hubs-resource-manager-namespace-event-hub-enable-capture.md)
...
### [À l’aide de PowerShell tooprovision entités](event-hubs-manage-with-ps.md) 
