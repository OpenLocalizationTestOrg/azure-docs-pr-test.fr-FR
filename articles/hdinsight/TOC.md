...
#### [Utilisez hello la ruche de vue](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Utiliser les outils de hello HDInsight pour Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Utiliser le Bureau à distance](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Utilisez hello Console de requête](hdinsight-hadoop-use-hive-query-console.md)
...
### [Exécution des exemples de MapReduce hello](hdinsight-hadoop-run-samples-linux.md)
...
#### [Utilisez hello .NET SDK](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Écriture tooData Lake Store](hdinsight-storm-write-data-lake-store.md)
...
### [Utilisez les outils HDInsight toocreate Spark applications](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Utilisez les outils HDInsight toodebug Spark applications à distance via SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Se connecter à Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Connectez-vous à l’aide du pilote JDBC de la ruche de hello](hdinsight-connect-hive-jdbc-driver.md)
...
### [Connecter le réseau local de tooyour HDInsight](connect-on-premises-network.md)
...
#### [Utiliser des applications tooinstall REST](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Publier des applications de HDInsight tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## Sécuriser
...
### [Restreindre l’accès toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Gérer
...
#### [Utilisez cURL et hello API REST Azure](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Utilisez hello .NET SDK](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Utilisez hello CLI d’Azure](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Utilisez hello portail Azure](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Utilisez hello CLI d’Azure](hdinsight-administer-use-command-line.md)
### [Gérer les clusters à l’aide de l’interface utilisateur web de Ambari hello](hdinsight-hadoop-manage-ambari.md)
...
### [Migrer des outils de développement tooResource Manager](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Disponibilité et fiabilité](hdinsight-high-availability-linux.md)
### [Mise à niveau de la version toonewer du cluster HDInsight](hdinsight-upgrade-cluster.md)
...
#### [Utilisez des vues d’Ambari toodebug Tez tâches](hdinsight-debug-ambari-tez-view.md)
...
# Rubriques connexes
## Clusters Windows
### [Migrer des clusters tooLinux de clusters Windows](hdinsight-migrate-from-windows-to-linux.md)
### [Migration des clusters de tooLinux solutions .NET](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Utiliser des graphiques de Giraph tooprocess à grande échelle](hdinsight-hadoop-giraph-install.md)
...
### [Utiliser des applications Java Maven toobuild](hdinsight-hbase-build-java-maven.md)
### [Utilisez hello Tez UI toodebug Tez travaux](hdinsight-debug-tez-ui.md)
...
### [Analyser les clusters à l’aide de hello Ambari API](hdinsight-monitor-use-ambari-api.md)

# Ressources
## [Feuille de route Azure](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Obtenir de l’aide sur le forum de hello](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
