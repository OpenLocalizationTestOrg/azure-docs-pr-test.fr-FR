...
## [Déplacer des applications de toologic MABS applications](logic-apps-move-from-mabs.md)
...
### [Comment toohandle EDIFACT documents ayant un segment UNH2.5](logic-apps-enterprise-integration-edifact_inputfile_unh2.5.md)
...
### [Se connecter aux données local tooon](logic-apps-gateway-connection.md)
