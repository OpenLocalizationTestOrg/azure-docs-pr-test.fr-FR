...
| [az webapp log download](https://docs.microsoft.com/cli/azure/webapp/log#download) | Téléchargements hello consigne de hello un ordinateur local du tooyour d’application web Azure. |
