...
### <a name="install-hello-azure-iot-hub-sdk-on-edison"></a>Installer hello Azure IoT Hub SDK sur Edison
Installer hello Azure IoT Hub SDK sur Edison en exécutant hello de commande suivante :

```bash
gulp install-tools
```

Cette tâche peut prendre un toocomplete beaucoup de temps, en fonction de votre connexion réseau. Elle a besoin toobe s’exécute qu’une seule fois pour un seul Edison.
