...
* Un USB-SD adaptateur ou miniSD carte tooburn hello image système d’exploitation sur une carte microSD de hello.
...
2. Installez Raspbian toohello microSD carte.
   ...
   6. Insérer carte microSD de hello Pi.
