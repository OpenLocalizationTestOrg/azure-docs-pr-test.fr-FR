...
> [!NOTE]
> Lors de la connexion à Raspberry Pi, vous pouvez utiliser une clé SSH au lieu du nom d’utilisateur et du mot de passe. Pour cela, vous devez générer la clé à l’aide **ssh-keygen** et **pi ssh-copy-id @\<adresse du périphérique\>**.
>
