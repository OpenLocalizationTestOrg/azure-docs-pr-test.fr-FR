...
1. Installez tous les packages en hello commande suivante. Cela inclut Azure IoT device SDK, la bibliothèque de capteur BME280 et la bibliothèque de câblage de Pi.
   ...
   ```
   > [!NOTE] 
   Il peut prendre plusieurs minutes toofinish ce processus d’installation en fonction de votre connexion réseau.
...
Exécuter l’exemple d’application hello en exécutant hello de commande suivante :
