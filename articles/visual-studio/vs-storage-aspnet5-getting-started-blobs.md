...
Il existe d’autres contenu de hello toolist manières d’un conteneur d’objets blob. Pour plus d’informations, consultez la section [Prise en main du stockage d’objets blob Azure à l’aide de .NET](../storage/blobs/storage-dotnet-how-to-use-blobs.md#list-the-blobs-in-a-container) .
...
Il existe autres façons toosave BLOB en tant que fichiers. Pour plus d’informations, consultez la section [Prise en main du stockage d’objets blob Azure à l’aide de .NET](../storage/blobs/storage-dotnet-how-to-use-blobs.md#download-blobs) .
