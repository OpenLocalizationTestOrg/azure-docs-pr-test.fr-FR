...
Pour plus d’informations sur la façon toouse hello **CloudTable** d’objets, consultez [prise en main le stockage de Table Azure à l’aide de .NET](../storage/storage-dotnet-how-to-use-tables.md).
