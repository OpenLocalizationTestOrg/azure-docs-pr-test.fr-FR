...
---
# <a name="use-cli-toocreate-a-single-azure-sql-database-and-configure-a-firewall-rule"></a>CLI toocreate une base de données SQL Azure et de configurer une règle de pare-feu

Cet exemple de script CLI crée une base de données SQL Azure et configure une règle de pare-feu au niveau du serveur. Une fois l’exécution du script de hello a réussi, hello de que base de données SQL est accessible à partir de tous les services Azure et hello configuré adresse IP. 
...
| [az sql server create](/cli/azure/sql/server#create) | Crée un serveur logique que les ordinateurs hôtes hello de base de données SQL. |
...
| [az sql db create](/cli/azure/sql/db#create) | Crée hello de base de données SQL dans un serveur logique de hello. |
