...
---
# <a name="use-powershell-toosync-between-multiple-azure-sql-databases"></a>Utilisez toosync PowerShell entre plusieurs bases de données SQL Azure
 
Cet exemple PowerShell configure toosync de synchronisation des données entre plusieurs bases de données SQL Azure.
