...
---
# <a name="use-powershell-toocreate-elastic-pools-and-move-databases-between-elastic-pools"></a>Utiliser les pools élastiques de PowerShell toocreate et déplacer des bases de données entre les pools élastiques

Cet exemple de script PowerShell crée deux pools élastiques déplace une base de données à partir d’un pool élastique dans un autre pool élastique et puis déplace une base de données hors d’un niveau de performance de base de données unique tooa pool élastique. 
