...
---
# <a name="use-powershell-toosync-between-an-azure-sql-database-and-a-sql-server-on-premises-database"></a>Utilisez toosync PowerShell entre une base de données SQL Azure et une base de données locale SQL Server

Cet exemple PowerShell configure toosync de synchronisation des données entre une base de données SQL Azure et une base de données SQL Server locale. 

Cet exemple requiert hello Azure PowerShell version 4.2 ou ultérieur du module. Exécutez `Get-Module -ListAvailable AzureRM` version de hello installé toofind. Si vous avez besoin de tooinstall ou mise à niveau, consultez [installez Azure PowerShell module](https://docs.microsoft.com/en-us/powershell/azure/install-azurerm-ps).
...
Après avoir exécuté le script d’exemple hello, vous pouvez exécuter hello suivant du groupe de ressources de commande tooremove hello et toutes les ressources associées avec lui.
...
| [New-AzureRmSqlSyncAgentKey](/powershell/module/azurerm.sql/New-AzureRmSqlSyncAgentKey) |  Génère la clé d’agent hello associé à l’agent de synchronisation hello |
| [Get-AzureRmSqlSyncAgentLinkedDatabase](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncAgentLinkedDatabase) |  Obtenir toutes les informations de hello pourquoi l’Agent de synchronisation |
| [New-AzureRmSqlSyncMember](/powershell/module/azurerm.sql/New-AzureRmSqlSyncMember) |  Ajouter un toohello membre nouveau groupe de synchronisation |
| [Update-AzureRmSqlSyncSchema](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncSchema) |  Actualise les informations de schéma de base de données hello |
| [Get-AzureRmSqlSyncSchema](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncSchem) |  Obtenir des informations de schéma de base de données hello |
| [Update-AzureRmSqlSyncGroup](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncGroup) |  Les mises à jour hello groupe de synchronisation |
| [Start-AzureRmSqlSyncGroupSync](/powershell/module/azurerm.sql/Start-AzureRmSqlSyncGroupSync) | Déclenche une synchronisation |
| [Get-AzureRmSqlSyncGroupLog](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncGroupLog) |  Vérifications hello journal de synchronisation |
|||
