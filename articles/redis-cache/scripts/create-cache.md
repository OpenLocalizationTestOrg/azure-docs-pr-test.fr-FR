...
Dans ce scénario, vous découvrez comment toocreate un Azure Redis Cache.
...
Ce script utilise hello suivant de commandes toocreate un groupe de ressources et d’un cache redis. Chaque commande figurant dans la documentation spécifique du toocommand liens table hello.
