...
toocreate vos données de bout en bout de l’entrepôt de solution, choisissez parmi un large éventail d’outils de pointe.  Cet article met en évidence les sociétés partenaires de Microsoft qui proposent des solutions d’aide à la décision (BI) prenant en charge Azure SQL Data Warehouse.

## <a name="our-business-intelligence-partners"></a>Nos partenaires décisionnels
| Partenaire | Description | Liens | Vidéos |
| --- | --- | --- | --- |
| ![Birst][1] |**Birst**<br>Birst est un leader mondial en matière d’outils décisionnels cloud et d’outils d’analyse. Entreprises peuvent créer une source fiable des données au sein du contexte hello de chaque utilisateur de la clé d’entreprise. Ensuite, les utilisateurs des activités dans toute organisation de hello peuvent signaler et analyser les informations à l’aide des Outils BI. |[Marketplace][birst_marketplace]<br>[Site Web][birst_website]<br>[Twitter][birst_twitter]<br>[YouTube][birst_youtube] | |
| ![ClearStory Data][2] |**ClearStory Data**<br>ClearStory Data assure une analyse rapide d’un ensemble de données disparates stockées dans SQL Data Warehouse. La plateforme Spark intégrée et l’application d’analyse de ClearStory accélèrent l’accès aux données et l’harmonisation de jeux de données hétéroclites. Elles permettent d’exploration rapide et de collaboration qui permet de gagner en toogain autonome utilisateurs toobe. |[Site web][clearstory_website]<br>[Feuille de données][clearstory_datasheet]<br>[Twitter][clearstory_twitter]<br>[YouTube][clearstory_youtube] | |
| ![Dell Statistica][3] |**Dell Statistica**<br>Dell statistique est une plate-forme d’analytique avancée qui permet aux organisations toomake des prédictions à propos hello future, optimiser les processus, réduire les coûts et augmenter le chiffre d’affaires.  Dell Statistica simplifie l’analyse des données volumineuses (« Big Data »), rationalise l’implémentation et le déploiement, extrait des informations exploitables à partir d’un texte et répond aux besoins de votre entreprise. |[Marketplace][dell_statistica_marketplace]<br>[Site Web][dell_statistica_website]<br>[Feuille de données][dell_statistica_datasheet]<br>[Twitter][dell_statistica_twitter]<br>[YouTube][dell_statistica_youtube] |[![Vidéo Statistica](./media/sql-data-warehouse-partner-business-intelligence/dell_statistica_video.jpg)](https://www.youtube.com/watch?v=0b8sPW2UHrU) |
...
| ![Jinfonet][5] |**JReport**<br>JReport est une solution Décisionnelle intégrable pour les entreprises hello. solution de Hello permet aux utilisateurs toocreate rapports et tableaux de bord analyse de données sur le cloud, les données et les sources de données transactionnelle. En visualisant des données, vous pouvez effectuer vos propres tâches de création de rapports et de découverte de données afin de bénéficier d’une possibilité de prise de décision agile à la volée. |[Site Web][jinfonet_website]<br>[Feuille de données][jinfonet_datasheet]<br>[Twitter][jinfonet_twitter]<br>[YouTube][jinfonet_youtube] |[![Vidéo jreport](./media/sql-data-warehouse-partner-business-intelligence/jinfonet_video.jpg)](https://www.youtube.com/watch?v=KYqh8TuMpds) |
| ![LogiAnalytics][6] |**Logi Analytics**<br>Ensemble, logique Analytique et Azure SQL Data Warehouse permet toocollect de votre organisation, analyser et agir immédiatement sur hello plus grand et plus de divers jeux de données dans Bonjour. |[Marketplace][logianalytics_marketplace]<br>[Site Web][logianalytics_website]<br>[Feuille de données][logianalytics_datasheet]<br>[Twitter][logianalytics_twitter]<br>[YouTube][logianalytics_youtube] |[![Vidéo logianalytics](./media/sql-data-warehouse-partner-business-intelligence/logianalytics_video.jpg)](https://www.youtube.com/watch?v=7U0Sfi3Ndpk) |
| ![Looker][7] |**Looker BI**<br>Looker donne à tout le monde dans votre tooexplore de capacité hello entreprise et de comprendre les données hello que les lecteurs de votre entreprise. Looker également donne analyste de données hello un flexible et réutilisable toocontrol de la couche de modélisation et curate ces données.  Les entreprises ont transformés fondamentalement leur culture à l’aide de Looker en tant que catalyseur de hello. |[Marketplace][looker_marketplace]<br>[Site Web][looker_website]<br>[Feuille de données][looker_datasheet]<br>[Twitter][looker_twitter]<br>[YouTube][looker_youtube] |[![Vidéo looker](./media/sql-data-warehouse-partner-business-intelligence/looker_video.jpg)](https://www.youtube.com/watch?v=WwO4ADK8ZfA) |
| ![Qlik][8] |**Qlik Sense Enterprise**<br>Détection d’informations de lecteur avec application de visualisation de données hello toute personne peut utiliser. Avec Qlik Sense, toute personne au sein de votre organisation peut créer, en toute simplicité, des visualisations flexibles et interactives et prendre des décisions explicites. |[Site Web][qlik_website]<br>[Twitter][qlik_twitter]<br>[YouTube][qlik_youtube] |[![Vidéo qlikview](./media/sql-data-warehouse-partner-business-intelligence/qlik_video2.jpg)](https://www.youtube.com/watch?v=VJEDFE-07Hg) |
| ![SiSense][9] |**SiSense**<br>SiSense est un logiciel de Business Intelligence de la pile complète qui est fourni avec les outils qu’une entreprise doit tooanalyze et visualiser les données : une base de données analytique hautes performances, le hello capacité toojoin plusieurs sources, d’extraction de données simple (ETL) et données basées sur le web visualisation. Démarrer tooanalyze et visualiser des jeux de données volumineux avec SiSense BI et Analytique aujourd'hui. |[Marketplace][sisense_marketplace]<br>[Site Web][sisense_website]<br>[Feuille de données][sisense_datasheet]<br>[Twitter][sisense_twitter]<br>[YouTube][sisense_youtube] |[![Vidéo sisense](./media/sql-data-warehouse-partner-business-intelligence/sisense_video.jpg)](https://www.youtube.com/watch?v=6N3mkTWI5R4) |
| ![Tableau][10] |**Tableau**<br>Analytique de libre-service de tableau aider tout le monde à connaître et comprendre leurs données, de nombreux types de données à partir de fichiers plats toodatabases. Tableau a un tooMicrosoft natif et optimisée connecteur Azure SQL Data Warehouse qui prend en charge les données actives et en mémoire analytique. |[Marketplace][tableau_marketplace]<br>[Site Web][tableau_website]<br>[Feuille de données][tableau_datasheet]<br>[Twitter][tableau_twitter]<br>[YouTube][tableau_youtube] |[![Vidéo tableau](./media/sql-data-warehouse-partner-business-intelligence/tableau_video.jpg)](https://www.youtube.com/watch?v=TwbkI3ZzCHE) |
| ![Targit][11] |**Targit**<br>Targit Decision Suite offre une plateforme décisionnelle et d’analyse regroupant dans une même solution cohésive des tableaux de bord en temps réel, des analyses en libre service, des fonctions de création de rapports conviviales, de remarquables fonctionnalités mobiles et une technologie de découverte de données simple. Targit donne sociétés hello courage tooact. |[Marketplace][targit_marketplace]<br>[Site Web][targit_website]<br>[Twitter][targit_twitter]<br>[YouTube][targit_youtube] |[![Vidéo targit](./media/sql-data-warehouse-partner-business-intelligence/targit_video.jpg)](https://www.youtube.com/watch?v=A0vET80Ker4) |
| ![Yellowfin][12] |**Yellowfin**<br>À nageoires jaunes est un meilleur classé des fournisseurs de Cloud BI pour la création de rapports ad hoc et des tableaux de bord par BARC ; Hello BI enquête. Connecter tooAzure SQL Data Warehouse, puis créer et de partager des magnifiques rapports et tableaux de bord avec primée collaboration BI et l’emplacement fonctionnalités Business intelligence. |[Marketplace][yellowfin_marketplace]<br>[Site Web][yellowfin_website]<br>[Feuille de données][yellowfin_datasheet]<br>[Twitter][yellowfin_twitter]<br>[YouTube][yellowfin_youtube] |[![Vidéo yellowfin](./media/sql-data-warehouse-partner-business-intelligence/yellowfin_video.jpg)](https://www.youtube.com/watch?v=i1q33AftI0A) |

<!--https://img.youtube.com/vi/0b8sPW2UHrU/0.jpg-->

## <a name="next-steps"></a>Étapes suivantes
toolearn savoir plus sur certaines des autres partenaires, consultez [partenaires d’intégration de données] [ di_partners] et [partenaires de la gestion des données][dm_partners].
