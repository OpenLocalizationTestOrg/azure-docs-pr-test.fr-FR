...
## [Utilisez AAD auth tooaccess API](media-services-use-aad-auth-to-access-ams-api.md)
### [Utilisez le portail toomanage AAD auth](media-services-portal-get-started-with-aad.md)
...
### [CLI toocreate et de configurer l’application d’AAD](media-services-cli-create-and-configure-aad-app.md)
### [Utilisez PowerShell toocreate et configurer l’application d’AAD](media-services-powershell-create-and-configure-aad-app.md)
...
#### [Utiliser MES tooauto-générer une échelle de la vitesse de transmission](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [Comment les miniatures toogenerate à l’aide de Media Encoder Standard avec .NET](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [Configurer la protection du contenu dans le portail de hello](media-services-portal-protect-content.md)
### [Configurer une clé en clair AES-128 pour votre diffusion](media-services-protect-with-aes128.md)
### [Utilisez reste tooencrypt votre contenu avec chiffrement de stockage](media-services-rest-storage-encryption.md)
...
### [À l’aide de partenaires toodeliver Widevine licences tooMedia Services](media-services-licenses-partner-integration.md)
#### [À l’aide de Axinom tooMedia de licences Widevine toodeliver des Services](media-services-axinom-integration.md)
#### [À l’aide de castLabs tooMedia de licences Widevine toodeliver des Services](media-services-castlabs-integration.md)
...
### [Analyser le média à l’aide du portail de hello](media-services-portal-analyze.md)
...
### [Insérer des publicités côté client de hello](media-services-inserting-ads-on-client-side.md)
