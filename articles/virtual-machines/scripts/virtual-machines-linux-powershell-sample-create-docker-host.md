...
Ce script crée une machine virtuelle avec Docker activé et démarre un conteneur exécutant NGINX. Après avoir exécuté le script de hello, vous pouvez accéder serveur de web NGINX hello via hello nom de domaine complet de hello machine virtuelle Azure. 
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Ajouter un ordinateur virtuel de machine virtuelle extension toohello. Dans cet exemple, hello extension Docker est utilisé tooconfigure Docker et exécuter un conteneur NGINX Docker. |
