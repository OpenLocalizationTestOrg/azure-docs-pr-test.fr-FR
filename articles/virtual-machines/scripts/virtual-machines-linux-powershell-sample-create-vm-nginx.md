...
Ce script crée une Machine virtuelle Azure, puis utilise hello Extension de Script personnalisé Azure Virtual Machine tooinstall NGINX. Après avoir exécuté le script de hello, vous pouvez accéder à un site Web de démonstration sur hello adresse IP publique de machine virtuelle de hello.
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Ajouter un ordinateur virtuel de machine virtuelle extension toohello. Dans cet exemple, extension de script personnalisé hello est utilisé tooinstall NGINX. |
