...
Ce script crée une machine virtuelle Azure avec un système d’exploitation Ubuntu. Après avoir exécuté le script de hello, vous pouvez accéder hello virtual machine via SSH.
