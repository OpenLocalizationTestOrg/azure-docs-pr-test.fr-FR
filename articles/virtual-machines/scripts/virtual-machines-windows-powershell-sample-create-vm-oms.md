...
Ce script crée une Machine virtuelle Azure installe l’agent Operations Management Suite (OMS) de hello et inscrit système hello avec un espace de travail OMS. Une fois le script de hello a exécuté, hello virtuels seront visibles dans la console OMS hello. En outre, vous devez tooupdate hello OMS espace de travail espace de travail et ID de clé.
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Ajouter un ordinateur virtuel de machine virtuelle extension toohello. Dans ce cas, hello extension de l’agent Operations Management Suite est utilisé tooinstall hello OMS agent et inscrire hello machine virtuelle dans un espace de travail OMS. |
