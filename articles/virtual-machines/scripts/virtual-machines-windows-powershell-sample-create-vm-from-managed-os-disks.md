...
| Commande | Remarques |
|---|---|
| [Get-AzureRmDisk](/powershell/module/azurerm.compute/Get-AzureRmDisk) | Obtient l’objet de disque basé sur le nom de hello et le groupe de ressources hello d’un disque. Propriété d’ID de hello retourné objet de disque est utilisé tooattach hello disque tooa nouvelle machine virtuelle |
...
| [Set-AzureRmVMOSDisk](/powershell/module/azurerm.compute/set-azurermvmosdisk) | Attache un disque géré à l’aide de la propriété d’Id hello du disque de hello en tant que système d’exploitation disque tooa machine virtuelle |
