...
Ce script crée une machine virtuelle Azure exécutant Windows Server 2016. Après avoir exécuté le script de hello, vous pouvez accéder hello virtual machine via RDP.
