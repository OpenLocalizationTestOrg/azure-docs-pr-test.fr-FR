...
# Prise en main
## [Configurer une machine virtuelle Bonjour portail Azure](virtual-machines-windows-portal-sql-server-provision.md)
## [Provisionner une machine virtuelle avec Azure PowerShell](virtual-machines-windows-ps-sql-create.md)
## [Se connecter tooa machine virtuelle](virtual-machines-windows-sql-connect.md)
...
## Gérer
### [Utilisez hello Extension de l’Agent SQL Server IaaS](virtual-machines-windows-sql-server-agent-extension.md)
