...
# Prise en main
## [Configurer une machine virtuelle Bonjour portail Azure](../sql/virtual-machines-windows-portal-sql-server-provision.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fsqlclassic%2ftoc.json)
## [Provisionner une machine virtuelle avec Azure PowerShell](virtual-machines-windows-classic-ps-sql-create.md)
## [Se connecter tooa machine virtuelle](virtual-machines-windows-classic-sql-connect.md)
...
### [Configurer le groupe de disponibilité Always On dans le portail classique de hello](virtual-machines-windows-classic-portal-sql-alwayson-availability-groups.md)
...
### [Étendre tooAzure de groupe de disponibilité local](virtual-machines-windows-classic-sql-onprem-availability.md)
## Gérer
### [Utilisez hello Extension de l’Agent SQL Server IaaS](virtual-machines-windows-classic-sql-server-agent-extension.md)
...
### [Utilisez PowerShell toocreate une machine virtuelle Azure avec un serveur de rapports](virtual-machines-windows-classic-ps-sql-report.md)
