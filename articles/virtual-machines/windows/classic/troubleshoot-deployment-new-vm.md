...
> [!IMPORTANT] 
> Azure dispose de deux modèles de déploiement différents pour créer et utiliser des ressources : [le déploiement Resource Manager et le déploiement classique](../../../resource-manager-deployment-model.md). Cet article décrit à l’aide du modèle de déploiement classique hello. Microsoft recommande que la plupart des nouveaux déploiements de modèle du Gestionnaire de ressources hello. Pour la version de gestionnaire de ressources hello de cet article, consultez [ici](../../virtual-machines-windows-troubleshoot-deployment-new-vm.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
téléchargement de ces deux erreurs, tooresolve hello du disque dur virtuel d’origine, disponible localement, avec hello même configuration que celle pour hello du système d’exploitation (généralisé/spécialisé). tooupload comme généralisé, n’oubliez pas tout d’abord toorun sysprep. Consultez [création et téléchargement d’un disque dur virtuel de Windows Server de tooAzure](createupload-vhd.md) pour plus d’informations.
