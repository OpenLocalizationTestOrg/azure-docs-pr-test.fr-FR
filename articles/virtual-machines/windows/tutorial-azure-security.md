...
Avance toolearn de didacticiel suivant toohello toocreate un CD/de l’élément de configuration de pipeline avec Visual Studio Team Services et une machine virtuelle de Windows qui exécute IIS.
