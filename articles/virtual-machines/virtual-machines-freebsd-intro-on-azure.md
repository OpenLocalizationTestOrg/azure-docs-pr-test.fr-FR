...
* Si vous souhaitez toobring vos propres tooAzure FreeBSD, reportez-vous trop[créer et charger un tooAzure FreeBSD VHD](linux/classic/freebsd-create-upload-vhd.md).
