...
En septembre 2016, Microsoft a publié une fonctionnalité vous permettant de gérer plusieurs adresses IP virtuelles à l’aide d’un [équilibrage de charge interne Azure][load-balancer-multivip-overview]. Cette fonctionnalité existe déjà dans le programme d’équilibrage de charge externe Azure hello.
...
> [!NOTE]
> Cette fonctionnalité est disponible uniquement dans le modèle de déploiement du Gestionnaire de ressources Azure hello.
