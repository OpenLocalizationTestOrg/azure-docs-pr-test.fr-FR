...
Voici la configuration requise pour les machines virtuelles Linux prenant en charge RDMA tooaccess hello réseau RDMA Azure :
...
[HPC Pack](https://technet.microsoft.com/library/jj899572.aspx), gratuit HPC cluster et le travail de solution de gestion de Microsoft, est une option pour vous, les instances de calcul intensif hello toouse avec Linux. Hello dernières versions de HPC Pack prend en charge plusieurs distributions Linux toorun sur nœuds déployés dans des machines virtuelles de Azure, gérés par un nœud principal de Windows Server. Avec les nœuds de calcul Linux prenant en charge RDMA Intel MPI en cours d’exécution, HPC Pack peut planifier et exécuter des applications Linux MPI réseau RDMA accès hello. Consultez [Prise en main des nœuds de calcul Linux dans un cluster HPC Pack dans Azure](classic/hpcpack-cluster.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json).
