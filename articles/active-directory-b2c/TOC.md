...
## [Utiliser les API d’Azure AD Graph hello](active-directory-b2c-devquickstarts-graph-dotnet.md)
...
## [Personnalisation de l’interface utilisateur de hello](active-directory-b2c-reference-ui-customization.md)
...
## [Utilisez hello API de création de rapports](active-directory-b2c-reference-usage-reporting-api.md)
