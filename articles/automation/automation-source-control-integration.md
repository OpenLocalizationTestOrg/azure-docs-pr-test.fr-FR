...
4. Actualisez votre référentiel GitHub une fois la tâche terminée pour afficher les modifications.  Il doit y avoir une validation de votre référentiel avec un message de validation : **mise à jour *le nom du Runbook* dans Azure Automation.**  
