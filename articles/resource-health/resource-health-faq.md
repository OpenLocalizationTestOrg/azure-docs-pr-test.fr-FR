...
* [Ce qui concerne l’intégrité des ressources hello ?](#what-is-the-resource-health-intended-for)
* [Quels contrôles d’intégrité sont effectués par Resource Health ?](#what-health-checks-are-performed-by-resource-health)
* [Que signifie chaque état de santé hello ?](#what-does-each-of-the-health-status-mean)
* [Ce que hello moyenne de l’état inconnu ? Y a-t-il un problème avec ma ressource ?](#what-does-the-unknown-status-mean-is-something-wrong-with-my-resource)
...
* [Comment diffère l’intégrité des ressources de notifications de hello hello ou de tableau de bord de Service d’intégrité de service du portail Azure ?](#how-is-resource-health-different-from-the-service-health-dashboard-or-the-azure-portal-service-notifications)
* [Dois-je tooactivate l’intégrité des ressources pour chaque ressource ?](#do-i-need-to-activate-resource-health-for-each-resource)
* [Nous devons l’intégrité des ressources tooenable pour mon organisation ?](#do-we-need-to-enable-resource-health-for-my-organization)
* [Resource Health est-il disponible gratuitement ?](#is-resource-health-available-free-of-charge)
* [Quelles sont les recommandations hello assurant l’intégrité des ressources ?](#what-are-the-recommendations-that-resource-health-provides)
...
## <a name="what-is-hello-resource-health-intended-for"></a>Ce qui concerne l’intégrité des ressources hello ?
...
1. Disponible : Il ne sont pas tous les problèmes connus dans hello plateforme Azure qui pourrait être ayant un impact sur cette ressource
2. Non disponible : Contrôle d’intégrité a détecté des problèmes qui ont un impact sur les ressources de hello
3. Inconnu : L’intégrité des ressources ne peut pas déterminer la santé d’une ressource hello, car il a annulé la réception des informations le concernant. 
...
Vous pouvez soumettre une demande de support à partir du Panneau de contrôle d’intégrité des ressources hello. Vous n’avez pas besoin de contrat de support avec Microsoft tooopen une demande lors de la ressource de hello n’est pas disponible, car les événements de plateforme.
...
Dans le portail hello, les actions initiées par l’utilisateur sont affichées à l’aide d’une icône de notification de bleu, tandis que les événements planifiés et sont à l’aide d’une icône d’avertissement rouge. Plus de détails sont fournis dans hello [vue d’ensemble du contrôle d’intégrité de ressource](Resource-health-overview.md).  
...
1. Accédez tooyour ressource. Dans hello navigation gauche, cliquez sur **l’intégrité des ressources**.
2. Accédez à panneau de moniteur Azure toohello.  Dans hello navigation gauche, cliquez sur **l’intégrité des ressources**.
3. Ouvrez hello **aide et Support** panneau en cliquant sur le point d’interrogation hello dans hello coin supérieur droit du portail de hello, puis en sélectionnant **aide et Support**. Une fois le panneau de hello s’ouvre, cliquez sur **l’intégrité des ressources**

Vous pouvez également utiliser l’intégrité des ressources hello API tooobtain plus d’informations sur le contrôle d’intégrité hello de vos ressources.
...
Il est important toonotice que tooprovide terminer de visibilité d’événements ayant un impact sur vos ressources, l’intégrité des ressources met également en évidence les événements publiés dans les notifications de Service et hello tableau de bord de Service d’intégrité.
...
## <a name="do-we-need-tooenable-resource-health-for-my-organization"></a>Nous devons l’intégrité des ressources tooenable pour mon organisation ?
