...
Dans ce scénario, vous allez apprendre comment une application de la fonction à l’aide de toocreate hello [le plan de la consommation](../functions-scale.md#consumption-plan) avec ses ressources connexes et en permanence déploie votre code de fonction à partir d’un référentiel de Visual Studio Team Services (VSTS). Pour cet exemple, vous avez besoin des éléments suivants :
...
Ce script utilise hello suivant de commandes toocreate un groupe de ressources, l’application web, documentdb et toutes les ressources. Chaque commande figurant dans la documentation spécifique du toocommand liens table hello.
