...
3. **Source et cible** :
    ...
    ![Réplication Hyper-V/VMM vers Azure](./media/site-recovery-components/arch-onprem-onprem-azure-vmm.png) ![la réplication de site Hyper-V vers Azure](./media/site-recovery-components/arch-onprem-azure-hypervsite.png)
