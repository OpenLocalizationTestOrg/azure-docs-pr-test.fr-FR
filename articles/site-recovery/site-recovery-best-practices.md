...
**Prérequis** | **Répliquer des machines virtuelles WMware/serveurs physiques sur Azure** | * **Répliquer les serveurs de machines virtuelles de VMware/physiques pour le site secondaire**  
---|---|---
