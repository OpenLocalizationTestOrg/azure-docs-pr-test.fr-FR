...
#### [Ajouter du stockage tooAzure sauvegarde du serveur](backup-mabs-add-storage.md)
#### [Mise à niveau du serveur de sauvegarde Azure toov.2](backup-mabs-upgrade-to-v2.md)
...
#### [Utilisez tooback Azure Backup Server d’un serveur VMware](backup-azure-backup-server-vmware.md)
#### [Utilisez tooback Azure Backup Server Exchange](backup-azure-exchange-mabs.md)
#### [Utiliser Azure Backup Server tooback d’une batterie de serveurs SharePoint](backup-azure-backup-sharepoint-mabs.md)
#### [Utilisez tooback de sauvegarde du serveur Azure SQL](backup-azure-sql-mabs.md)
...
### Préparer hello machine virtuelle
...
#### [Sauvegarder les machines virtuelles de coffre de Services de récupération tooa](backup-azure-arm-vms.md)
...
### [Utilisez tooback System Center DPM Exchange Server](backup-azure-backup-exchange-server.md)
### [Récupérer des données tooan autre serveur DPM](backup-azure-alternate-dpm-server.md)
### [Utilisez tooback DPM des charges de travail de SQL Server](backup-azure-backup-sql.md)
### [DPM tooback d’utiliser une batterie de serveurs SharePoint](backup-azure-backup-sharepoint.md)
...
### [Récupérer des fichiers à partir d’Azure tooWindows Server](backup-azure-restore-windows-server.md)
...
### Sauvegarder et restaurer à l’aide du portail classique de hello
#### [Windows Server à l’aide du modèle de déploiement classique de hello](backup-configure-vault-classic.md)
#### [Gérer les coffres de sauvegarde à l’aide du modèle de déploiement classique de hello](backup-azure-manage-windows-server-classic.md)
#### [Récupérer des fichiers tooa Windows Server à l’aide du modèle de déploiement classique de hello](backup-azure-restore-windows-server-classic.md)

## Coffre Recovery Services
### [Vue d’ensemble des coffres Recovery Services](backup-azure-recovery-services-vault-overview.md)
### [La mise à niveau d’un coffre de sauvegarde coffre tooRecovery Services](backup-azure-upgrade-backup-to-recovery-services.md)
...
### [Échec de sauvegarde de machine virtuelle Azure : pas pu communiquer avec l’agent de machine virtuelle hello pour l’état de capture instantanée - la sous-tâche de machine virtuelle de capture instantanée a expiré](backup-azure-troubleshoot-vm-backup-fails-snapshot-timeout.md)
