...
Pour obtenir un exemple de la définition de variables d’environnement hello Bonjour [portail Azure](https://portal.azure.com) pour une application web Azure, consultez [à l’aide de Node.js web application hello Service de Table Azure].
