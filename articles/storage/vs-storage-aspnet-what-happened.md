...
---
# <a name="what-happened-toomy-aspnet-project-visual-studio-azure-storage-connected-service"></a>Le projet ASP.NET toomy s’est produit (Visual Studio Azure Storage connecté service) ?
...
Dans le fichier web.config de hello de votre projet, un élément a été créé avec la chaîne de connexion et la clé du compte de stockage hello sélectionné.
