...
Créer un contexte de compte de stockage hello. contexte de Hello encapsule la clé de compte et le nom du compte de stockage hello. Pour obtenir des instructions sur la copie de votre clé de compte à partir de hello [portail Azure](https://portal.azure.com), consultez [clés d’accès afficher et copier](storage-create-storage-account.md#view-and-copy-storage-access-keys).
