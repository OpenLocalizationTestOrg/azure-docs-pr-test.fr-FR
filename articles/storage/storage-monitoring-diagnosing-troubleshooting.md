...
Vous pouvez choisir les métriques toutes les heures souhaitées toodisplay Bonjour [portail Azure](https://portal.azure.com) et configurer des règles pour avertir les administrateurs par courrier électronique chaque fois qu’une mesure horaire dépasse un seuil spécifique. Pour plus d’informations, consultez [Réception de notifications d’alerte](../monitoring-and-diagnostics/insights-receive-alert-notifications.md). 
