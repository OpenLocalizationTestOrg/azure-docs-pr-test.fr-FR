...
> [!NOTE]
> Le stockage Azure utilise [stockage de table](../common/storage-introduction.md#table-storage) toostore les métriques de hello pour votre compte de stockage et les métriques de hello de magasins dans les tables de votre compte. Pour plus d’informations, consultez. [Stockage des métriques](../common/storage-analytics.md#how-metrics-are-stored).
>
