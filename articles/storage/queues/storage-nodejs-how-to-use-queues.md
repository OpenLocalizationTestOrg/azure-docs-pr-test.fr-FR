...
Pour obtenir un exemple de la définition de variables d’environnement hello Bonjour [portail Azure](https://portal.azure.com) pour un site Web Azure, consultez [application web Node.js avec] hello Service de Table Azure.
...
* Visitez hello [Team Blog du stockage Azure] [Blog de l’équipe stockage Azure].
...
[Créer et déployer un tooan d’application Node.js Azure Cloud Service](../../cloud-services/cloud-services-nodejs-develop-deploy-app.md)   
[Azure Storage Team Blog] : http://blogs.msdn.com/b/windowsazurestorage/ [générer et déployer un tooAzure d’application web Node.js à l’aide de Web Matrix] : https://www.microsoft.com/web/webmatrix/   
