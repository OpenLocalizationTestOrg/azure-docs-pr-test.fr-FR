...
3. **Chemin d’accès de copie hello UNC du volet de « Se connecter » hello Bonjour Azure portal**: une description détaillée de toofind ces informations peuvent être trouvées comment [ici](storage-how-to-use-files-portal.md#connect-to-file-share).
