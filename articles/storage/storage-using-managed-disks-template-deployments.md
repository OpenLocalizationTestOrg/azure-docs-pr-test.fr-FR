...
* Visitez hello [vue d’ensemble des disques Azure administrés](storage-managed-disks-overview.md) toolearn document savoir plus sur des disques gérés.
