---
title: "aaaAzure Documentation Storage - didacticiels, référence de l’API | Documents Microsoft"
description: "Découvrez comment toouse Azure Storage - stockage Blob, Table, file d’attente, fichier et disque de Machine virtuelle dans le cloud de hello. Didacticiels, références d’API et autres documents."
services: storage
author: carolz
manager: carolz
layout: LandingPage
...
Découvrez comment toouse le stockage Azure, un stockage cloud de service qui est fiable, disponible et évolutive. Didacticiels, des références de l’API et toute autre documentation vous montrent comment tooset configurer et gérer le stockage Blob, Table, file d’attente, fichier et disque de Machine virtuelle.
