...
Dans cet article, nous parlons de différentes utilisations de hello pour les disques de hello et puis discuter hello différents types de disques, vous pouvez créer et utiliser. Cet article est également disponible pour les [machines virtuelles Windows](storage-about-disks-and-vhds-windows.md).
...
* [Attacher un disque](../virtual-machines/linux/add-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) tooadd de stockage supplémentaire pour votre machine virtuelle.
