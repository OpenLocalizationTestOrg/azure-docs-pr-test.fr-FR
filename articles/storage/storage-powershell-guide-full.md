...
Pour plus d’informations, consultez [à l’aide de Signatures SAP (accès partagé)](storage-dotnet-shared-access-signature-part-1.md) et [gérer l’accès en lecture anonyme toocontainers et les objets BLOB](storage-manage-access-to-resources.md).
