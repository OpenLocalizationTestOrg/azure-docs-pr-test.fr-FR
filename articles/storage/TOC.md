...
### [Attacher un disque géré de tooa machine virtuelle Windows à l’aide de PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [L’accès anonyme tooblobs](storage-manage-access-to-resources.md)
...
### [Migrer des machines virtuelles Azure tooAzure gérés disques](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Migrer à partir de AWS et d’autres plateformes tooManaged disques](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Migration tooPremium de stockage à l’aide d’Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [Migrer tooPremium stockage](storage-migration-to-premium-storage.md)
...
### [Utilisez hello émulateur de stockage](storage-use-emulator.md)
...
### [Déplacer les données tooand du stockage](storage-moving-data.md)
### [AzCopy sur Windows](storage-use-azcopy.md)
### [AzCopy sur Linux](storage-use-azcopy-linux.md)
### [À l’aide du service d’importation/exportation hello](storage-import-export-service.md)
### [À l’aide de hello outil Import/Export](storage-import-export-tool-how-to.md)
#### [Configuration de hello outil Import/Export](storage-import-export-tool-setup.md)
...
#### [Résolution des problèmes de hello outil Import/Export](storage-import-export-tool-troubleshooting-v1.md)
...
### [À l’aide de l’outil Import/Export (v1) de hello](storage-import-export-tool-how-to-v1.md)
#### [Configuration de hello outil Import/Export](storage-import-export-tool-setup-v1.md)
...
#### [Format du fichier de propriétés et métadonnées du service Import/Export](storage-import-export-file-format-metadata-and-properties.md)
#### [Format du fichier journal du service Import/Export](storage-import-export-file-format-log.md)
### [À l’aide des API REST du service Azure Import/Export hello](storage-import-export-using-the-rest-api.md)
