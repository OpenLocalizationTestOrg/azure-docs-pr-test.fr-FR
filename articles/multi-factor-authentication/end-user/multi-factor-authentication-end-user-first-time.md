...
Lorsque votre service informatique vous impose de toostart à l’aide de la vérification en deux étapes, vous verrez un écran qui indique **votre administrateur exige que vous définissez ce compte pour la vérification de sécurité supplémentaires**:
