...
|**Démarrage rapide**|[Azure Cosmos DB : Créer une application graphique à l’aide de .NET et hello API Graph](create-graph-dotnet.md)|
|**Didacticiel**|[Azure CosmosDB : Créer un conteneur avec hello API Graph](tutorial-develop-graph-dotnet.md)|
...
N’importe quel tooAzure demande Cosmos de base de données à l’aide d’un kit de développement logiciel mis hors service est rejetée par le service de hello.

## <a name="see-also"></a>Voir aussi
toolearn en savoir plus sur hello Azure Cosmos DB Graph API, consultez [Introduction tooAzure Cosmos DB : API Graph](graph-introduction.md). 
