...
---
# <a name="get-account-keys-for-azure-cosmos-db-using-hello-azure-cli"></a>Obtenir des clés de compte de base de données Azure Cosmos à l’aide hello CLI d’Azure
...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Crée un serveur logique que les ordinateurs hôtes hello de base de données SQL. |
