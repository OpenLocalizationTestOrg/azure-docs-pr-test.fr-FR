...
3. Dans la zone de recherche hello Hello catalogue Microsoft Update, entrez le nombre de Base de connaissances (KB) hello de hello correctif souhaité toodownload, par exemple **3179904**, puis cliquez sur **recherche**.
   
    Hello correctif liste s’affiche, par exemple, **Cumulative 2.2 de mise à jour logicielle offre groupée pour StorSimple 8000 Series**.
...
5. Recherche de tous les correctifs supplémentaires répertoriées dans le tableau hello ci-dessus (**3103616**, **3146621**) et ajoutez chaque panier toohello.
...
4. Type **Y** lorsque tooconfirm demandée hello installation du correctif logiciel.
   ...
   > [!IMPORTANT]
   > Si l’installation de mise à jour 2.2, installer uniquement le fichier binaire de hello commençant par 'all-hcsmdssoftwareudpate'. N’installez pas hello Cis hello MDS agent mise à jour et précédé d’all-cismdsagentupdatebundle. Échec toodo entraînerait une erreur. 
...
1. Une fois la mise à jour logicielle de hello est terminée, vérifiez les versions des logiciels système hello. Entrez :
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. Répétez les étapes 3 à 5 tooinstall hello est restant les correctifs en mode normal.
   
   * mise à jour iSCSI Hello KB3146621
   * mise à jour WMI Hello KB3103616
3. Ignorez cette étape si vous mettez à jour à partir de la mise à jour 2. Si vous mettez à jour à partir d’un tooUpdate préalable de version 2, vous devez également toodownload :

    - pilote Hello LSI KB3121900

    - mise à jour Spaceport Hello KB3090322

    - mise à jour Storport Hello KB3080728
