...
## <a name="create-a-blank-sql-database-using-the-azure-portal"></a>Créer une base de données SQL vide grâce au portail Azure
...
## <a name="create-a-server-level-firewall-rule-using-the-azure-portal"></a>Créer une règle de pare-feu au niveau du serveur à l’aide du portail Azure
...
## <a name="get-connection-string-values-using-the-azure-portal"></a>Obtenir la connexion des valeurs de chaîne à l’aide du portail Azure
