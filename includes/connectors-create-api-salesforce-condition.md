Cette condition évaluera le champ d’adresse de messagerie hello de chaque nouveau prospect Salesforce. Si l’adresse de messagerie hello contient *amazon.com*, résultat de condition hello sera *True*.
