...
3. Dans la zone de recherche hello Hello catalogue Microsoft Update, entrez le nombre de Base de connaissances (KB) hello de hello correctif souhaité toodownload, par exemple **3121901**, puis cliquez sur **recherche**.
   
    Hello correctif liste s’affiche, par exemple, **Cumulative 2.0 de mise à jour logicielle offre groupée pour StorSimple 8000 Series**.
...
5. Recherche de tous les correctifs supplémentaires répertoriées dans le tableau hello ci-dessus (**3121900**, **3080728**, **3090322**, et **3121899**), ajoutez chaque panier d’achat de Hello.
...
6. Après les logiciels hello mise à jour est terminée, répète les étapes 3 à 5 tooinstall et analyse hello SaaS agents et MDS. Veillez à installer `all-hcsmdssoftwareupdate_0b438ddf0d5b686aada2378b754fac8c7f2160e9.exe` avant `all-cismdsagentupdatebundle_f98e62f4d56c79e2a6644d027af7a2393a93827a.exe`.
7. Vérifiez les versions des logiciels système hello. Entrez :
...
8. Répétez les étapes 3 à 5 tooinstall hello est restant les correctifs en mode normal.
   
   * Hello pilote LSI - KB3121900
   * Hello mise à jour Storport - KB3080728
   * Hello mise à jour Spaceport - KB3090322
