Il existe certaines limites de nombre hello des métriques et des événements par l’application (autrement dit, par clé d’instrumentation). Les limites dépendent hello [plan de tarification](https://azure.microsoft.com/pricing/details/application-insights/) que vous choisissez.
...
| Limitation | 32 000 événements par seconde | limite de Hello est mesurée sur une minute.
