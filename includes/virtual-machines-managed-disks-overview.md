...
**Type de stockage :** Managed Disks propose 2 niveaux de performance : [Premium](../articles/storage/common/storage-premium-storage.md) (disques SSD) et [Standard](../articles/storage/common/storage-standard-storage.md) (disque dur). facturation Hello d’un disque géré varie selon le type de stockage que vous avez sélectionné pour le disque de hello.
...
[Instantanés incrémentiels](../articles/virtual-machines/windows/incremental-snapshots.md) ne sont actuellement pas pris en charge pour les disques gérés, mais il le sera dans hello futures.
...
* [Comment toocapture une image managée d’une machine virtuelle généralisée dans Azure](../articles/virtual-machines/windows/capture-image-resource.md)
* [Comment toogeneralize et une machine virtuelle Linux à l’aide de la capture hello Azure CLI 2.0](../articles/virtual-machines/linux/capture-image.md)
...
* [Créer une VM Linux à l’aide de hello Azure CLI 2.0](../articles/virtual-machines/linux/quick-create-cli.md)

* [Attacher un tooa de disque de données managées machine virtuelle Windows à l’aide de PowerShell](../articles/virtual-machines/windows/attach-disk-ps.md)

* [Ajouter un tooa disque géré Linux VM](../articles/virtual-machines/linux/add-disk.md)
...
* [Migrer à partir de AWS et d’autres plateformes tooManaged des disques dans Azure](../articles/virtual-machines/windows/on-prem-to-azure.md)

* [Convertir les disques toomanaged de machines virtuelles Azure dans Azure](../articles/virtual-machines/windows/migrate-to-managed-disks.md)
